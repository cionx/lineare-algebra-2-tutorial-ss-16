...
% TODO: Bijektion zwischen Idempotenten und Bijektionen

% TODO: Bijektion zwischen Idempotenten und Involutiven mit gleicher Zerlegung

% TODO: Multiplikative Jordanzerlegungung für GL_n
...
\begin{question}
  ...
  \begin{enumerate}[leftmargin=*]
    ...
    \item
      Mithilfe des Endomorphismus $gf$ von $V$.
  \end{enumerate}
\end{question}
...
\begin{question}
  ...
  Ferner seien
  \[
    L_\alpha \coloneqq \Rbb \alpha
    \quad\text{und}\quad
    H_\alpha \coloneqq L_\alpha^\perp = \alpha^\perp.
  \]
  \begin{enumerate}[leftmargin=*]
    \item
    ...
    \item
      Zeigen Sie, dass für jede orthogonale Isomorphismus $t \colon V \to V$ die Identität
      \[
